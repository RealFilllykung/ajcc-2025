...
export default function Home() {
  return (
    <main className="flex flex-col min-h-[200vh] text-white" style={{ backgroundColor: "#BC002D" }}>
      {/* Hero Section */}
      <section className="flex flex-col items-center justify-center min-h-screen relative">
        <div className="text-center space-y-4">
          ...
          <p className="text-xl md:text-2xl">from Tharathep Klinla-or (Fill)</p>
        </div>

        <div className="m-8 flex flex-col items-center animate-bounce">
